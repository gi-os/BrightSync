#!/usr/bin/env python3
"""Build BrightSync's launcher mark.
...
MARK = [
    ('M28.57,48.59 A26.00,26.00 0 0 1 79.43,48.59', 5, False),
    ('M81.37,57.69 L70.91,44.58 L85.58,41.46 Z', 0, False),
    ('M79.43,59.41 A26.00,26.00 0 0 1 28.57,59.41', 5, False),
    ('M26.63,50.31 L37.09,63.42 L22.42,66.54 Z', 0, False),
]
...
<!--
  BrightSync launcher mark. One of the unified Bright* set: 108 canvas, 18..90
